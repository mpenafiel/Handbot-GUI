...
namespace IntelliStretch.UI
{
    public partial class UIConnection : UserControl
    {
        ...
        private void JointConnect_Click(object sender, RoutedEventArgs e)
        {
            if (e.Source == BtnWristConnect)
            {
                Console.WriteLine("Wrist clicked");
                BtnWristConnect.IsChecked = true;
                BtnMCPConnect.IsChecked = false;
                BtnDualConnect.IsChecked = false;
            }
            else if (e.Source == BtnMCPConnect)
            {
                Console.WriteLine("MCP Clicked");
                BtnWristConnect.IsChecked = false;
                BtnMCPConnect.IsChecked = true;
                BtnDualConnect.IsChecked = false;
            }

            else if (e.Source == BtnDualConnect)
            {
                Console.WriteLine("Dual Clicked");
                BtnWristConnect.IsChecked = false;
                BtnMCPConnect.IsChecked = false;
                BtnDualConnect.IsChecked = true;
            }
        }
    }
}
